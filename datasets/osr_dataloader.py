...
class MNIST_OSR(object):
    def __init__(self, known, dataroot='./data/mnist', use_gpu=True, num_workers=8, batch_size=128, img_size=32):
        ...
        trainset = MNIST_Filter(root=dataroot, train=True,
        ...
        testset = MNIST_Filter(root=dataroot, train=False,
        ...
        outset = MNIST_Filter(root=dataroot, train=False,
                              download=True, transform=transform)
        ...
        print('Train: ', len(trainset), 'Test: ',
              len(testset), 'Out: ', len(outset))
...
class SVHN_OSR(object):
    def __init__(self, known, dataroot='./data/svhn', use_gpu=True, num_workers=8, batch_size=128, img_size=32):
        ...
        testset = SVHN_Filter(root=dataroot, split='test',
                              download=True, transform=transform)
        print('All Test Data:', len(testset))
        testset.__Filter__(known=self.known)
        ...
        outset = SVHN_Filter(root=dataroot, split='test',
                             download=True, transform=transform)
        outset.__Filter__(known=self.unknown)
...
class Tiny_ImageNet_OSR(object):
    def __init__(self, known, dataroot='./data/tiny_imagenet', use_gpu=True, num_workers=8, batch_size=128, img_size=64):
        ...
        trainset = Tiny_ImageNet_Filter(os.path.join(
            dataroot, 'tiny-imagenet-200', 'train'), train_transform)
        print('All Train Data:', len(trainset))
        trainset.__Filter__(known=self.known)
        ...
        testset = Tiny_ImageNet_Filter(os.path.join(
            dataroot, 'tiny-imagenet-200', 'val'), transform)
        print('All Test Data:', len(testset))
        testset.__Filter__(known=self.known)
        ...
        outset = Tiny_ImageNet_Filter(os.path.join(
            dataroot, 'tiny-imagenet-200', 'val'), transform)
        outset.__Filter__(known=self.unknown)
...
class ixi_slice_OSR(object):
    def __init__(self, known, dataroot='./data/ixi_slice', use_gpu=True, num_workers=10, batch_size=256, img_size=64):
        ...
        trainset = ixi_slice_Filter(os.path.join(
            dataroot, 'ixi_slice', 'train'), train_transform)
        print('All Train Data:', len(trainset))
        trainset.__Filter__(known=self.known)
        ...
        testset = ixi_slice_Filter(os.path.join(
